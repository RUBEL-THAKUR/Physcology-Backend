...
public class TherapistProfileService {
    ...
    // ✅ SAVE / UPDATE BASIC INFO (JWT based)
    @Transactional
    public TherapistProfile saveBasicInfo(
            String token,
            TherapistProfileBasicInfoRequest req
        ...
        TherapistProfile profile = repository
    ...
    // ✅ GET BASIC INFO (JWT based)
    public TherapistProfile getBasicInfo(String token) {
        UUID therapistId = jwtUtil.extractTherapistId(token);
    ...
    // ✅ DELETE BASIC INFO (JWT based)
    @Transactional
    public void deleteBasicInfo(String token) {
        UUID therapistId = jwtUtil.extractTherapistId(token);
